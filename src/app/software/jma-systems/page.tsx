          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center gap-6">
              ...
              >
                ...
                {currentLang === "en" ? "Previous: E-commerce" : "前: Eコマース"}
              </Link>

              <Link
                href="/software/techdoctor"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-700 text-white font-display font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
                {currentLang === "en" ? "Next: TechDoctor" : "次: TechDoctor"}
