...
// 横断再利用フッター（components/）。言語に依存しない静的表示のため props なし。
    ...
    <footer className="mt-32 border-t border-hairline bg-canvas">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="font-display italic text-xl text-ink leading-none mb-1">Kento Yokozuka</p>
            <p className="font-body text-sm text-ink-muted">Software Engineer &amp; UI/UX Designer</p>
          </div>
