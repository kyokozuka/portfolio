...
export const UIUXContactSection = ({ contactText }: UIUXContactSectionProps) => {
  return (
    <section className="mb-20 animate-fadeIn">
      <article className="text-center">
        <article className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/50 max-w-4xl mx-auto">
          <header>
...
export default UIUXContactSection;
